...
const Wtu = () => {
  const person = {
    ...
    biography: `
        Dr. Tsang-Wei Tu is an Associate Professor of Radiology at Howard University. His research interest is on the development of novel imaging methods for the detection of neurological diseases. Dr. Tu applies a multi-disciplinary approach, combining imaging technologies with trauma biomechanics, immunohistochemistry, behavior, and molecular and cellular analysis to establish potential imaging matrices for neurological diseases, including neonatal hypoxia and traumatic brain injury. Dr. Tu’s research bridges radiological findings to the underlying pathophysiology to help identification of therapeutic effects in the brain.
        <br /><br />
